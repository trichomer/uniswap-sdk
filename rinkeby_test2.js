...
const fs = require('fs');
const { Token, WETH, Fetcher, Route, Trade, TokenAmount, TradeType, Percent, Pair } = require("@uniswap/sdk");
const { getAddress } = require("ethers/lib/utils");

const url = 'https://eth-rinkeby.alchemyapi.io/v2/PmyL7a0Qlf5R8u_0rw8PqVRLOdlwGouu';
...
swapTokens(DAI, WETH[DAI.chainId], .0001) //first argument = token we want, second = token we have, the amount we want